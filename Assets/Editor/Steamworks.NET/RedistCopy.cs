...
public class RedistCopy {
	...
	public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject) {
		...
		{
			CopyFile("steam_api64.dll", "steam_api64.dll", "Assets/Plugins/x86_64", pathToBuiltProject.Remove(pathToBuiltProject.IndexOf(strProjectName)) + strProjectName + "_Data/Plugins");
		}
		else if (target == BuildTarget.StandaloneWindows)
		{
			CopyFile("steam_api.dll", "steam_api.dll", "Assets/Plugins/x86", pathToBuiltProject.Remove(pathToBuiltProject.IndexOf(strProjectName)) + strProjectName + "_Data/Plugins");
		}
